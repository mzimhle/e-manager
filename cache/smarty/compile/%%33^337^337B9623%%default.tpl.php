<?php /* Smarty version 2.6.20, created on 2015-06-27 18:17:24
         compiled from campaigns/MU3H/0860/facility/default.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'number_format', 'campaigns/MU3H/0860/facility/default.tpl', 62, false),)), $this); ?>
...
smarty_core_smarty_include_php(array('smarty_file' => ($this->_tpl_vars['smartypath'])."/includes/javascript.php", 'smarty_assign' => '', 'smarty_once' => false, 'smarty_include_vars' => array()), $this); ?>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			'; ?>
<?php $_from = $this->_tpl_vars['productData']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['gallery'] = array('total' => count($_from), 'iteration' => 0);
...
<?php echo '_click").click(function() {
				$.fancybox.open([
					'; ?>
<?php $_from = $this->_tpl_vars['item']['productimages']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['fancyimage'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['fancyimage']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['image']):
        $this->_foreach['fancyimage']['iteration']++;
?><?php echo '
					{ href : '; ?>
'http://<?php echo $this->_tpl_vars['image']['campaign_domain']; ?>
<?php echo $this->_tpl_vars['image']['productimage_path']; ?>
/big_<?php echo $this->_tpl_vars['image']['productimage_code']; ?>
<?php echo $this->_tpl_vars['image']['productimage_extension']; ?>
', title : '<?php echo $this->_tpl_vars['image']['productimage_description']; ?>
' <?php echo '}'; ?>
...
?>
			<div class="galleryitem">
				<a href="javascript:;" class="fancybox_<?php echo $this->_tpl_vars['item']['product_code']; ?>
_click"> 
					<img class="extra-img png" width="200" src="<?php echo $this->_tpl_vars['item']['productimage_path']; ?>
/tmb_<?php echo $this->_tpl_vars['item']['productimage_code']; ?>
...
" />
				...
				<br />
				<b class="gallerytitle"><?php echo $this->_tpl_vars['item']['product_name']; ?>
</b><br />
				<p><?php echo $this->_tpl_vars['item']['product_description']; ?>
</p>
...
?>
				...
				<br />
				<?php if (! empty ( $this->_tpl_vars['item']['productprices'] )): ?>
				<?php $_from = $this->_tpl_vars['item']['productprices']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['productprice']):
?>
				<p class="sectionitem"><?php echo $this->_tpl_vars['productprice']['productprice_name']; ?>
 - R <?php echo ((is_array($_tmp=$this->_tpl_vars['productprice']['productprice_price'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 2, ",", ".") : number_format($_tmp, 2, ",", ".")); ?>
</p>				
				<?php endforeach; endif; unset($_from); ?>	
				<?php else: ?>
