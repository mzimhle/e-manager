...
/* Setup Pagination. */
$administratorData = $administratorObject->getAll("administrator_deleted = 0",'administrator.administrator_added DESC');

$smarty->assign_by_ref('administratorData', $administratorData);

/* End Pagination Setup. */ 
$smarty->display('administration/campaign/accounts/default.tpl');
?>