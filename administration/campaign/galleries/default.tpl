...
<div id="container">
  ...
  <div id="content">
	...
	<a href="/administration/campaign/galleries/details.php" title="Click to Add a new gallery" class="blue_button fr mrg_bot_10"><span style="float:right;">Add a new gallery</span></a> <br />
		...
		<div class="content_table">			
			<table id="dataTable" border="0" cellspacing="0" cellpadding="0">
			  ...
			  <tr>
				...
				<td align="left"><a href="/administration/campaign/galleries/details.php?code={$item.gallery_code}">{$item.gallery_name}</a></td>		
