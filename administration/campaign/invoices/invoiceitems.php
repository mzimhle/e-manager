...
if (isset($_GET['code']) && trim($_GET['code']) != '') {
	...
	$campaigninvoiceData = $campaigninvoiceObject->getByCode($code);

	if($campaigninvoiceData) {
		$smarty->assign('campaigninvoiceData', $campaigninvoiceData);
	} else {
		header('Location: /administration/campaign/campaigninvoices/');
		exit;
	}
} else {
	header('Location: /administration/campaign/campaigninvoices/');
...
$campaignproductPairs = $campaignproductObject->pairs($campaigninvoiceData['campaign_code']);
...
$smarty->display('administration/campaign/campaigninvoices/invoiceitems.tpl');
