   ...
   //declare table variables
	 ...
	 */ 
	 ...
	 public function insert(array $data) {
		...
		$data['administrator_code']	= $this->createReference();
	...
	public function getAll($where = 'administrator_deleted = 0', $order = 'administrator_name desc')
	{
		$select = $this->_db->select()	
						->from(array('administrator' => 'administrator'))	
     ...
     * @return object
	 */
	public function campaignLogin($username = '', $password= '')
	{
		$select = $this->_db->select()	
						->from(array('administrator' => 'administrator'))	
						->joinLeft(array('campaign' => 'campaign'), 'campaign.campaign_code = administrator.campaign_code')		
	   ...
	   if($result) {
			$productcampaignitemData = $this->_campaign->_productcampaignitem->getCampaignPages($result['campaign_code']);
