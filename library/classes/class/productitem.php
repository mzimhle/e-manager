...
class class_productitem extends Zend_Db_Table_Abstract
{
   //declare table variables
	 ...
	 public function insert(array $data)
    {
        ...
        $data['productitem_code']  	= $this->createReference();
	...
	public function remove($code) {
		return $this->delete('productitem_code = ?', $code);		
	}
	...
	public function getAll($where = 'productitem_deleted = 0', $order = 'productitem_name desc')
	{
	...
	public function getCode($reference)
	{
		$select = $this->select() 
					->from(array('productitem' => 'productitem'))
					   ->where('productitem_code = ?', $reference)
					   ->limit(1);
